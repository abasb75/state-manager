...
export type MSExposedMSActions<MSActions,MSState > 
    = MSActions extends (...args: any[]) => any ? MSActions : {
    [K in keyof MSActions]: 
      [MSActions[K], MSAction<MSState,any>] extends [MSAction<MSState,any>, MSActions[K]] ? MSExposedAction<MSState,MSActions[K]> : MSExposedMSActions<MSActions[K], MSState>
}
